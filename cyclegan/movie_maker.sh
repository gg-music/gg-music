...
mkdir $1/mp4
ffmpeg -y -framerate 2 -pattern_type glob -i $1'/'$2'_to_'$3'/*.png' -c:v libx264 -pix_fmt yuv420p $1/mp4/x_to_y.mp4
ffmpeg -y -framerate 2 -pattern_type glob -i $1'/'$3'_to_'$2'/*.png' -c:v libx264 -pix_fmt yuv420p $1/mp4/y_to_x.mp4
