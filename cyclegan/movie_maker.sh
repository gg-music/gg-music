...
ffmpeg -y -framerate 24 -pattern_type glob -i $MODEL_ROOT'/images/fake_y/*.png' -c:v libx264 -pix_fmt yuv420p $MODEL_ROOT/mp4/fake_x.mp4
ffmpeg -y -framerate 24 -pattern_type glob -i $MODEL_ROOT'/images/fake_x/*.png' -c:v libx264 -pix_fmt yuv420p $MODEL_ROOT/mp4/fake_y.mp4
ffmpeg -y -framerate 24 -pattern_type glob -i $MODEL_ROOT'/images/disc_fake_y/*.png' -c:v libx264 -pix_fmt yuv420p $MODEL_ROOT/mp4/disc_fake_x.mp4
ffmpeg -y -framerate 24 -pattern_type glob -i $MODEL_ROOT'/images/disc_fake_x/*.png' -c:v libx264 -pix_fmt yuv420p $MODEL_ROOT/mp4/disc_fake_y.mp4
ffmpeg -y -framerate 24 -pattern_type glob -i $MODEL_ROOT'/images/disc_real_y/*.png' -c:v libx264 -pix_fmt yuv420p $MODEL_ROOT/mp4/disc_real_x.mp4
ffmpeg -y -framerate 24 -pattern_type glob -i $MODEL_ROOT'/images/disc_real_x/*.png' -c:v libx264 -pix_fmt yuv420p $MODEL_ROOT/mp4/disc_real_y.mp4
